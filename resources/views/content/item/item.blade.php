              ...
              <tr>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <a class="dropdown-item" href="{{url('/item/'.(string)$item->ItemId).'/edit'}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                      <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{url('/item/'.(string)$item->ItemId).'/delete'}}" method="post">
                        @csrf
                        {{ method_field('DELETE') }}
